...
signUpForm.addEventListener('input', (event) => {
  ...
  const bindedValidator = signUpForm[signupName].checkValidation.bind(newUser);
  bindedValidator();

  btn.disabled = !signUpForm.checkFormValidation();

  signUpForm[signupName].value = signupValue;
